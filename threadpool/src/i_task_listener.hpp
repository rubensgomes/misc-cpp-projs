 ...
 * @author Rubens Gomes
 */
class ITaskListener: private boost::noncopyable
{
public:
     ...
     */
    virtual ITaskListener * clone(void) const = 0;
     ...
     */
    bool operator==(const ITaskListener &) const;
...
// as follows:
inline ITaskListener * new_clone(const ITaskListener & rhs)
{
  return rhs.clone();
}
